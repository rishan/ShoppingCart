<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="com.cart.misc.ShoeProduct"%>
...
<link rel="stylesheet" type="text/css"
	href="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.5.5/slick-theme.min.css">
...
<body>
	<nav class="navbar navbar-default navbar-inverse"
		style="opacity:0.8;position:fixed;width:100%;z-index:30">
	<div class="container" style="padding-top: 10px; padding-bottom: 10px;">
		<div class="navbar-header ">
			...
			<img src="../images/logo.jpg" alt="logo.jpg" width="20%"
				height="auto" class="pull-left hidden-xs" style="padding-right: 5px">
				...
				<div class="slickOuterCarousel lazy">
					<div>
						<div class="carousel slide article-slide"
							id="article-photo-carousel" data-ride="carousel"
							data-interval="false">
							<!-- Wrapper for slides -->
							<div class="carousel-inner cont-slider">
								<span id="username" style="display: none"><%=session.getAttribute("userID") %></span>
								<span id="productID" style="display: none"><%=shoeproduct.getProductID()%></span>
								<div class="item active">
									<img alt="" title="" src="<%=shoeproduct.getProductimage()%>"
										class="car-images">
								</div>
								<div class="item">
									<img alt="" title="" src="<%=shoeproduct.getProductimage2()%>"
										class="car-images">
								</div>
								<div class="item">
									<img alt="" title="" src="<%=shoeproduct.getProductimage3()%>"
										class="car-images">
								</div>
								<div class="item">
									<img alt="" title="" src="<%=shoeproduct.getProductimage4()%>"
										class="car-images">
								</div>
								<div class="item">
									<img alt="" title="" src="<%=shoeproduct.getProductimage5()%>"
										class="car-images">
								</div>
								<div class="item">
									<img alt="" title="" src="<%=shoeproduct.getProductimage6()%>"
										class="car-images">
								</div>
							</div>
							<!-- Indicators -->
							<ol class="carousel-indicators hidden-xs">
								<li class="active" data-slide-to="0"
									...
									src="<%=shoeproduct.getProductimage()%>"></li>
								<li class="" data-slide-to="1"
									data-target="#article-photo-carousel"><img alt=""
									src="<%=shoeproduct.getProductimage2()%>"></li>
								<li class="" data-slide-to="2"
									data-target="#article-photo-carousel"><img alt=""
									src="<%=shoeproduct.getProductimage3()%>"></li>
								<li class="" data-slide-to="3"
									data-target="#article-photo-carousel"><img alt=""
									src="<%=shoeproduct.getProductimage4() %>"></li>
								<li class="" data-slide-to="4"
									data-target="#article-photo-carousel"><img alt=""
									src="<%=shoeproduct.getProductimage5() %>"></li>
								<li class="" data-slide-to="5"
									data-target="#article-photo-carousel"><img alt=""
									src="<%=shoeproduct.getProductimage6()%>"></li>
							</ol>
							<a class="carousel-control left " href="#article-photo-carousel"
								data-slide="prev"> <span
								class="glyphicon glyphicon-chevron-left"></span>
							</a> <a class="carousel-control right" href="#article-photo-carousel"
				...
				<div class="options col-sm-10 no-padding">
					<div class="review">
						<div class="product_rating col-xs-12">
							<img src="../images/blue-star.png"> <img
								src="../images/blue-star.png"> <img
								src="../images/blue-star.png"> <img
								src="../images/blue-star.png"> <img
								src="../images/blue-star.png"> <span class="no_of_reviews"><%=shoeproduct.getNoreviews()%></span>
					...
					<div class="stock_delivery">
						<div class="product_availability col-xs-12 no-padding">
							<span class="availability">Availability: <span
								class="instock"><%=shoeproduct.getAvailability()%></span></span> <span
								class="delevierydays">Delivered in 3-5 days</span>
						</div>
					</div>
							...
							<div class="input-group">
								<div id="pin-check" class="input-group">
									<input type="text" class="form-control" pattern="[0-9]{6}"
										...
										class="input-group-btn"><button id="check"
											type="button" class="btn btn-default">CHECK</button></span>
								</div>
								<span class="text-center" id="pin-ok" style="display: none"><span
									class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>Available
									at your location
									</p></span>
							</div>
						</div>
					...
					<div class="buy">
						<div class="col-sm-12 col-xs-12 no-padding">
							<a id="add2cart"
								class="label label-primary col-sm-5 col-xs-5 no-border-radius ">ADD
								TO CART</a> <a id="added2cart"
								class="label label-success col-sm-5 col-xs-5 no-border-radius ">ADDED
								TO CART</a> <a id="add2wishlist"
								class="label label-primary col-sm-5 col-xs-5 col-sm-offset-2 col-xs-offset-2 no-border-radius">ADD
								TO WISHLIST</a>
						</div>
					</div>
				</div>
