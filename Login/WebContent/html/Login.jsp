		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<div>
					...
					<form class="form-horizontal" method="POST" action="/Login/Login" id="loginForm" name="login-form" novalidate>
						...
						<div>
							<a data-toggle="modal" data-target="#myModal"
								class="pull-right help-block hidden-xs" style="margin-top: 1px;cursor: pointer">Forgot
								Password</a>
						</div>
