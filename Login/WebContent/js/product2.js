$(document).ready(function() {
    ...
    product1+='<div class="product-description-container container-fluid">\
        ...
        <div class="product_details_sidebar col-sm-4">\
            ...
            <div class="options col-sm-10 no-padding">\
                ...
                <table class="table hidden-xs" style="margin-top:15px">\
                    <tr>\
                        <th>Unit Price</th>\
                        <th>Discount</th>\
                        <th>Total Price</th>\
                ...
                <div class="pincode">\
                    <div class="pin col-xs-10 no-padding">\
                        ...
                        <span class="text-center" id="pin-ok" style="display:none"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>Available at your location</span>\
                    </div>\
                </div>\
                <div class="buy">\
                    <div class="col-sm-12 col-xs-12 no-padding">\
                        <a href="Cart.html" id="add2cart" class="label label-primary col-sm-5 col-xs-5 no-border-radius ">ADD TO CART</a>\
                        <a href="Wishlist.html" class="label label-primary col-sm-5 col-xs-5 col-sm-offset-2 col-xs-offset-2 no-border-radius">ADD TO WISHLIST</a>\
                    </div>\
                </div>\
            </div>\
        </div>\
    ...
    <div class="container">\
        ...
        <table class="table table-bordered">\
            <tbody>\
                <tr>\
                    <th class="info" colspan="2">Mobile Details</th>\
                </tr>\
                <tr>\
                    <td>Call Features</td>\
                    <td> '+ abc.CallFeatures +'</td>\
                </tr>\
                <tr>\
                    <td>Model Name</td>\
                    <td> '+ abc.ModelName +' </td>\
                ...
                <tr>\
                    <td>Front Camera</td>\
                    <td> '+ abc.FrontCamera +' </td>\
                </tr>\
                <tr>\
                    <td>Rear Camera</td>\
                    <td> '+ abc.RearCamera +' </td>\
                </tr>\
                <tr>\
                    <td>Zoom</td>\
                    <td> '+ abc.Zoom +' </td>\
